...
| Tag   | HTTP Verbs | Endpoint               | Summary               | Description                                                  | OperationId     |
|-------|------------|------------------------|-----------------------|--------------------------------------------------------------|-----------------|
| Donations  | GET        | /api/v1/donations        | List all donations       | Retrieve all registered donations                                | GetAllDonations      |
| Donations  | POST       | /api/v1/donations         | Create a donation         | Register a new donation                   | CreateDonation      |
| Donations  | PUT        | /api/v1/donations/{id}    | Update donation| Update donation details using its ID                          | UpdateDonation      |
...
| Carlo Ramirez              | Desarrollo del bounded context de **Donations**                                           |
