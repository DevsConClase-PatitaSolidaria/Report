...
| :--------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------- |
| 1. Comunica oralmente con efectividad a diferentes rangos de audiencia. | **Diego Alonso Rosado Iporre** <br> TB2: He comunicado oralmente con efectividad a diferentes rangos de audiencia al participar en la elaboración y presentación del video *About the Product*, realizar una entrevista a una cuidadora como parte del testeo, y explicar el funcionamiento del backend y base de datos, así como el *bounded context* **Pets** y la sección **5.2.2** del informe técnico. <br><br> **Carlos Andrés Coca Lavado** <br> TB2: COMPLETAR <br><br> **Sebastian Aaron Anibal Carbajal Santivañez** <br> TB2: COMPLETAR <br><br> **Carlo Patricio Ramirez Escalante** <br> TB2: COMPLETAR <br><br> **Pedro Omar Lecca Villalobos** <br> TB2: Realicé las entrevistas para comunicar al equipo de desarrolo los las diferentes opiniones de nuestros segmentos objetivos acerca de nuestro producto final, mostrando los principales bounded context que realicé (Adoptions, Vaccines y Manage Adoptions). <br><br> **Arnold Gabriel Morales Sosa** <br> TB2: COMPLETAR <br><br>                                               | **Diego Alonso Rosado Iporre**<br> TB2: A través de mi participación en la elaboración del video *About the Product*, la entrevista realizada a una cuidadora durante el testeo, y la explicación técnica del backend, base de datos, el *bounded context* **Pets** y la sección **5.2.2** del informe, he logrado comunicar oralmente de forma efectiva ante diversas audiencias, cumpliendo con el resultado de aprendizaje ABET correspondiente. <br><br> **Carlos Andrés Coca Lavado** <br> TB2: COMPLETAR <br><br> **Sebastian Aaron Anibal Carbajal Santivañez** <br> TB2: COMPLETAR <br><br> **Carlo Patricio Ramirez Escalante** <br> TB2: COMPLETAR <br><br> **Pedro Omar Lecca Villalobos** <br> TB2: Completé el mostrar el producto final a cliente objetivo, de esta forma ver si llegamos a la solución esperada. Además, hice los bounded context Adoptions, Vaccines y Manage Adoptions. <br><br> **Arnold Gabriel Morales Sosa** <br> TB2: COMPLETAR <br><br>                                                                                                                                                 |
| 2. Comunica por escrito con efectividad a diferentes rangos de audiencia | **Diego Alonso Rosado Iporre**<br> TB2: He comunicado por escrito con efectividad a diferentes rangos de audiencia mediante la redacción completa del informe, incluyendo etiquetas de navegación y la descripción de anexos, estructurando la información de forma clara tanto para usuarios técnicos como no técnicos, cumpliendo con el resultado de aprendizaje ABET 2. <br><br> **Carlos Andrés Coca Lavado**<br> TB2: COMPLETAR <br><br> **Pedro Omar Lecca Villalobos**<br> TB2: He comunicado al público a detalle como funciona nuestra aplicación, dando información sin usar palabras técnicas, todo siendo entendible para el usuario promedio. <br><br> **Sebastian Aaron Anibal Carbajal Santivañez**<br> TB2: COMPLETAR <br><br> **Carlo Patricio Ramirez Escalante**<br> TB2: COMPLETAR <br><br> **Arnold Gabriel Morales Sosa**<br> TB2: COMPLETAR <br><br> | **Diego Alonso Rosado Iporre**<br> TB2: A partir de la redacción integral del informe, la incorporación de etiquetas de navegación y la elaboración de anexos explicativos, he logrado comunicar por escrito con claridad y precisión a distintos públicos. Esta documentación permitió transmitir eficazmente tanto los aspectos técnicos como los funcionales del proyecto, cumpliendo con el resultado ABET 2: comunicar por escrito con efectividad a diferentes rangos de audiencia. <br><br> **Carlos Andrés Coca Lavado**<br> TB2: COMPLETAR <br><br> **Pedro Omar Lecca Villalobos**<br> TB2: Incorporé el análisis respectivo y la opinión del entrevistado acerca de la solución 'PatitaSolidaria' viendo los temas de mejora o objetivos completados. <br><br> **Sebastian Aaron Anibal Carbajal Santivañez**<br> TB2: COMPLETAR <br><br> **Carlo Patricio Ramirez Escalante** <br> TB2: COMPLETAR <br><br> **Arnold Gabriel Morales Sosa**<br> TB2: COMPLETAR <br><br> |
...
| Image | <br><p align="center"><img height="100px" src="assets/images/commons/user-persona2.jpg"></p> |
...
<p align="center"><img width="auto" height="auto" src="assets/images/commons/Impact Mapping-PatitaSolidaria.jpg">
...
<img src="assets/images/commons/structurizr-92759-ContextoDelSistema.png">
...
<img src="assets/images/commons/structurizr-92759-Contenedores.png">
...
<img src="assets/images/commons/structurizr-92759-ComponentesAPI.png">
...
<p align="center"><img width="auto" height="auto" src="assets/images/commons/Gitflow.png">
...
- Creación Landing Page: 
    ...
    <p align="center"><img width="auto" height="auto" src="assets/images/commons/Creating-repo-1.png">

    2. Colocamos nombre y elegimos la opción public para que sea visible y seleccionamos "Create repository" y listo.

    <p align="center"><img width="auto" height="auto" src="assets/images/commons/creating-repo-2.png">
